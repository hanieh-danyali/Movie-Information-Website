...
AOS.init();
const sectionArtist = document.querySelector(".intro_artists1");
const artistbtn = document.querySelector(".artists__4");
const info = document.querySelector(".info");
const infoMOvie = document.querySelector(".main");
const about = document.querySelector(".about");
const aboutWebsite = document.querySelector(".aboutwebsite");

artistbtn.addEventListener("click", function () {
  sectionArtist.scrollIntoView({ behavior: "smooth" });
});

info.addEventListener("click", function () {
  infoMOvie.scrollIntoView({ behavior: "smooth" });
});
about.addEventListener("click", function () {
  aboutWebsite.scrollIntoView({ behavior: "smooth" });
});
